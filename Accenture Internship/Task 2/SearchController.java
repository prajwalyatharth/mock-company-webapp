...
public class SearchController {
    ...
    public Collection<ProductItem> search(@RequestParam("query") String query) {
         ...
         * The easiest implementation will be to use the findAll as we are below. Then
         * filter using Java
         * string methods such as contains(...), toLowerCase(...), equals(...), etc.
         *
         * The requirements are defined in
         * src/test/groovy/com/mockcompany/webapp/controller/SearchControllerSpec.groovy
         *
         * Read through the tests to get an idea of how search should work. When the
         * tests are written before the code,
         * it is known as Test Driven Development (TDD) and is a common best practice.
         * The Spock framework is a great
         * framework for TDD because the tests are written very descriptively using
         * sentences.
         *
         * https://spockframework.org/spock/docs/2.0/spock_primer.html
         *
         * For an added challenge, update the ProductItemRepository to do the filtering
